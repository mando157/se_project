...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?= BASE_URL ?>owner/index" class="active">
    ...
    <div class="main-content">
        <nav class="navbar px-4 py-3 f1">
            ...
            <div class="ms-auto d-flex align-items-center gap-3 f3">
                <a href="<?= BASE_URL ?>owner/analytics" class="nav-link f15 f4">Analytics</a>
                <a href="<?= BASE_URL ?>owner/reports" class="nav-link f4">Reports</a>
                <a href="<?= BASE_URL ?>owner/live-map" class="nav-link f4">Live Map</a>
                <button class="btn f5">Release All Slots</button>
                <a href="<?= BASE_URL ?>owner/notifications"><i class="fa-regular fa-bell icon f6"></i></a>
            </div>
        </nav>
...
<div class="dashboard">
    ...
    <div class="card earnings">
        ...
        <h2>
            ...
            <span
                id="earningsChangeSpan"
                class="<?= (($earningsChange ?? 0) >= 0) ? 'up' : 'down' ?>"
            >
                <?= (($earningsChange ?? 0) >= 0 ? '+' : '') ?>
                <?= $earningsChange ?? 0 ?>%
            </span>
        ...
        <p>
            vs.
            $<?= isset($lastMonthEarnings)
                ? number_format($lastMonthEarnings, 2)
                : '0.00'
            ?>
            last month
        </p>
    ...
    <div class="card bookings">
        ...
        <h2>
            ...
            <span
                id="bookingsChangeSpan"
                class="<?= (($bookingsChange ?? 0) >= 0) ? 'up' : 'down' ?>"
            >
                <?= (($bookingsChange ?? 0) >= 0 ? '+' : '') ?>
                <?= $bookingsChange ?? 0 ?>%
            </span>
    ...
    <div class="card occupancy">
        ...
        <h2>
            ...
            <span id="occupancyValue">
                <?= $occupancyRate ?? 0 ?>
            </span>%

            <span
                id="occupancyChangeSpan"
                class="<?= (($occupancyChange ?? 0) >= 0) ? 'up' : 'down' ?>"
            >
                <?= (($occupancyChange ?? 0) >= 0 ? '+' : '') ?>
                <?= $occupancyChange ?? 0 ?>%
            </span>
        ...
        <p>
            ...
            <span id="peakHourDisplay">

                <?= !empty($peakHour)
                    ? htmlspecialchars($peakHour)
                    : '14:00 - 16:00'
                ?>
    ...
    <div class="modal" id="modal">
        <div class="modal-box">
            ...
            <form action="<?= BASE_URL ?>owner/addSpace" method="POST">
                ...
                <div class="toggle-box">
                    <div>
                        ...
                        <p>Listing will be live immediately.</p>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            initChart(
                window.dbWeeklyRevenue,
                window.dbMonthlyRevenue
            );
