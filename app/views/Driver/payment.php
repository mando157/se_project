    ...
    <main class="container">
        ...
        <section class="left">
            ...
            <form method="POST" action="<?= BASE_URL ?>Driver/pay">
                ...
                <input type="hidden" name="extra_hours" value="<?= $extra_hours ?>">
                <button class="pay-btn" type="submit">
                    Confirm & Pay
                    $
                    <?php
                    if ($type == 'extend') {
                        echo htmlspecialchars($extra_cost);
                    } else {
                        echo htmlspecialchars($booking['total_cost']);
                    }
                    ?>
                </button>
            </form>
                ...
                <div class="content">
                    ...
                    <div class="info">
                        ...
                        <b id="duration">
                            <?php
                            if ($type == 'extend') {
                                echo "+ " . $extra_hours . " Hours";
                            } else {
                                echo htmlspecialchars($booking['duration']) . " Hours";
                            }
                            ?>
                        </b>
                    </div>
